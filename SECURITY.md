...
The model connection test sends only a minimal probe prompt to the configured model service. It does not send visible document text and does not require the user to confirm document sending.
